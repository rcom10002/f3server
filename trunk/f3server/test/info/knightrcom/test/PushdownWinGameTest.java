...
public class PushdownWinGameTest extends TestCase{
	...
	public void testGetPoints十三幺(){
		...
		int result = pushdownWinGame.testGetPoints(gameRecord);
		assertEquals(result, 100);
	}

	public void testGetPoints碰碰和(){
